...
mkdir -p /f/games/World\ of\ Warcraft/_retail_/Interface/AddOns/PetPet_Modern/
cp *.lua /f/games/World\ of\ Warcraft/_retail_/Interface/AddOns/PetPet_Modern/
cp PetPet_Modern.toc.tmp /f/games/World\ of\ Warcraft/_retail_/Interface/AddOns/PetPet_Modern/PetPet_Modern.toc
